...
export const DEELTE_SESSION_VIA_SESSIONID: string =
  "SELECT auth.delete_session_via_sessionId($1) as response";
...
export const GET_ALL_USER_SESSIONS: string =
  "SELECT auth.get_all_user_sessions($1) as response";
